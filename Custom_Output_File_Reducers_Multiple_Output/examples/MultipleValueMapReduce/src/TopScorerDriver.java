...
//inputdata contains students details studentname,studentmarks,student_schoolname,city
//We need to find out the highest mark as well as the details of the student	 
//There are two ways,in the value as singlekey,you append all the strings,or use a Custom class implementing Writable that can act as a Value	 
    ...
    //By default a folder is create output_data with 2 files _SUCCESS and part-r-00000
}
}  
